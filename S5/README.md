...
# NUCES Vault &bull; Semester 5 Notes

**Modular, high-performance course documentation for FAST-NUCES Semester 5.**  
*Single-page module architecture &bull; Zero external runtime dependencies &bull; Dark Zinc design system.*

---

[![FAST-NUCES](https://img.shields.io/badge/FAST--NUCES-Semester_5-d97757?style=for-the-badge)](https://nu.edu.pk/)
[![Stack](https://img.shields.io/badge/Stack-HTML5_|_CSS3_|_Vanilla_JS-27272a?style=for-the-badge)](./index.html)
[![Design](https://img.shields.io/badge/Theme-Dark_Zinc-18181b?style=for-the-badge)](./notes.css)
...
- **Modular Design:** Standalone HTML modules with single-view topic pagination.
- **Hub Search:** Client-side real-time multi-subject filter on [`index.html`](./index.html).
- **Responsive Layout:** Off-canvas drawer navigation for mobile, static sidebar for desktop.
- **Academic & Exam Prep:** Integrated concept definitions, pro tips, common pitfalls, and quiz banks.

---

### Quick Start

Open [`index.html`](./index.html) in any modern browser, or launch via local HTTP server:
